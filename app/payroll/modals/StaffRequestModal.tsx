                ...
                <div className='p-4 max-h-[60vh] overflow-y-auto'>
                    {!selectedStaffId ? (
                        <div className='space-y-2'>
                            <p className='text-sm text-white/50 mb-3'>Select a staff member to request payout for:</p>
                            {staffList.length === 0 ? (
                                <p className='text-sm text-white/40 text-center py-4'>No staff available</p>
                            ) : (
                        ...
                        <>
                            {loadingPending ? (
                                ...
                                <div className='text-center py-8'>
                                    <p className='text-white/40 text-sm'>No pending entries found for this staff member</p>
                                </div>
                            ) : (
                    ...
                    {selectedStaffId ? (
                        <>
                            ...
                            <button
                                ...
                                className='px-4 py-2 bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded text-sm font-medium transition-colors flex items-center gap-2'
                            >
                                {submittingRequest ? (
                                    <>
