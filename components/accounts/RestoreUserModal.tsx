        ...
        >
            ...
            <div className='w-full grid grid-cols-2 gap-2'>
                <button
                    title='Cancel'
                    type='button'
                    className='bg-red-400/20 px-2 py-1 font-semibold border-2 border-border rounded-lg cursor-pointer transition-colors hover:bg-red-400/30 active:hover:bg-red-400/40'
                    onClick={onClose}
                >
                    Cancel
                </button>
                <button
                    ...
                    type='button'
                    className='bg-green-400/20 px-2 py-1 font-semibold border-2 border-border rounded-lg cursor-pointer transition-colors hover:bg-green-400/30 active:hover:bg-green-400/40 text-nowrap'
