...
export default function CartPanel({
    ...
    return (
        <div className='w-full lg:w-sm flex flex-col h-full z-10 bg-muted backdrop-blur-lg border border-border rounded-xl'>
                ...
                {cart.length === 0 ? (
                    ...
                    cart.map((item) => {
                        ...
                        return (
                            <div
                                key={item.id}
                                className={`p-3 bg-zinc-50 dark:bg-muted/50 rounded-lg border border-zinc-100 dark:border-border flex flex-col gap-3`}
                            >
                                <div className='flex items-center justify-between w-full'>
                                    <div className='flex-1 min-w-0 mr-4 space-y-2'>
                                        ...
                                        <div className='flex items-center gap-1'>
                                            ...
                                            <input
                                                ...
                                                className='w-20 bg-muted border border-border rounded px-2 py-1 text-sm text-right'
                                                min='0'
                                                step='0.01'
                                            />
                                    ...
                                    <div className='flex items-center gap-3'>
                                        <div className='flex items-center gap-1 bg-white dark:bg-card rounded-lg border border-zinc-200 dark:border-border p-1'>
                                            <button
                                                onClick={() => updateQuantity(item.id, -1)}
                                                className='p-1 hover:bg-zinc-100 dark:hover:bg-muted rounded'
                                            >
                                ...
                                {isHourly && (
                                    <div className='flex flex-col gap-2 w-full'>
                                        <div className='flex-1'>
                                            <label className='block text-muted-foreground mb-1'>Total Hours</label>
                                            <input
                                                type='number'
                                ...
                                {/* Per-item label */}
                                <div className='w-full mt-2 pt-2 border-t border-zinc-200/50 dark:border-border/50'>
                                    <input
                                        type='text'
                                        ...
                                        maxLength={200}
                                        className='w-full bg-muted border border-border rounded px-2 py-1 text-xs text-muted-foreground placeholder:text-muted-foreground focus:outline-none focus:border-blue-500/50'
                                    />
                                </div>
                            </div>
                        )
            ...
            {/* Totals Section */}
            <div className='p-6 bg-zinc-50 dark:bg-muted/30 border-t border-zinc-200 dark:border-border'>
                <div className='space-y-2 mb-4'>
                    ...
                    <div className='flex justify-between text-xl font-bold text-foreground dark:text-foreground pt-2 border-t border-zinc-200 dark:border-border items-center'>
                        <span>Total</span>
                        <div className='flex items-center gap-2'>
                            <input
                                ...
                                className='w-28 bg-muted border border-border rounded px-2 py-1 text-xl font-bold text-right'
                                min='0'
                                step='0.01'
                            />
                            {totalOverride !== null && (
                ...
                {appliedDiscount > 0 ? (
                    <button
                        ...
                        className='w-full py-2 bg-red-100 hover:bg-red-200 dark:bg-red-900/20 dark:hover:bg-red-900/30 disabled:bg-zinc-100 dark:disabled:bg-muted disabled:cursor-not-allowed text-red-700 dark:text-red-400 disabled:text-muted-foreground rounded-lg font-medium transition-colors flex items-center justify-center gap-2'
                    >
                    ...
                    <button
                        ...
                        disabled={cart.length === 0}
                        className='w-full py-2 bg-zinc-200 hover:bg-zinc-300 dark:bg-zinc-700 dark:hover:bg-zinc-600 disabled:bg-zinc-100 dark:disabled:bg-muted disabled:cursor-not-allowed text-muted-foreground dark:text-foreground disabled:text-muted-foreground rounded-lg font-medium transition-colors flex items-center justify-center gap-2'
                    >
                ...
                <button
                    ...
                    disabled={cart.length === 0}
                    className='w-full py-4 bg-blue-600 hover:bg-blue-700 disabled:bg-zinc-300 disabled:cursor-not-allowed text-foreground rounded-xl font-bold text-lg shadow-lg hover:shadow-blue-500/30 transition-all flex items-center justify-center gap-2 mt-2'
                >
